 ...
 * @author ElectronWill
 */
public final class DebugLogPrintStream extends PrintStream {
	
	private final StringBuilder line = new StringBuilder();
	
	public DebugLogPrintStream() {
	...
	private DebugLogPrintStream logLine() {
		debug(line);
		line.setLength(0);
		return this;
	}
	
	private void debug(CharSequence cs) {
