...
public class SynchronizedBag<E> extends Bag<E> {
	 ...
	 * 
	 * @deprecated the returned iterator is not Thread-safe, therefore you MUST use it inside a synchronized(*the bag
